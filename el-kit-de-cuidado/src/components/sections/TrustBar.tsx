...
const trustItems = [
  {
    icon: Shield,
    title: "Aprobado por FDA",
    description: "Todos nuestros productos cumplen con los estándares de seguridad"
  },
  {
    icon: Star,
    title: "4.9/5 Estrellas",
    description: "Más de 50,000 mamás satisfechas"
  },
  {
    icon: Award,
    title: "6+ Años de Excelencia",
    description: "Líderes en cuidado maternal"
  },
  {
    icon: Users,
    title: "Equipo Bilingüe",
    description: "Hablamos español, te entendemos"
  }
];
