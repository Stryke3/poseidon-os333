...
exports.TEXT_NOT_SUPPLIED_BY_USER = exports.CLINICAL_GENERATION_RULES = exports.CLINICAL_GENERATION_POLICY_VERSION = void 0;
exports.lmnVariableSources = lmnVariableSources;
exports.swoVariableSources = swoVariableSources;
exports.CLINICAL_GENERATION_POLICY_VERSION = "1.0";
exports.CLINICAL_GENERATION_RULES = [
...
exports.TEXT_NOT_SUPPLIED_BY_USER = "[No diagnosis or clinical text was supplied by the user for this field — nothing was inferred.]";
/**
 * Maps each LMN template variable to its source path in `DocumentGeneratorInput` (audit).
 */
function lmnVariableSources() {
    return {
