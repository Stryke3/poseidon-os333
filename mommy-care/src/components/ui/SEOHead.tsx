...
export default function SEOHead({
  ...
  description = "Get your pregnancy and postpartum care kit covered by most insurance plans. FDA-approved, safe and medication-free products. We speak English.",
  keywords = "pregnancy kit, postpartum care, pregnancy insurance, free pregnancy products, belly band, compression stockings pregnancy, TENS pregnancy, mommy care, pregnancy care kit english",
