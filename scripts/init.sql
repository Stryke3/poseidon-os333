...
CREATE TABLE IF NOT EXISTS order_documents (
    ...
    doc_type VARCHAR(50) NOT NULL CHECK (doc_type IN (
        'swo','cmn','lmn','pod','abn','cms1500','dvt_addendum',
        'prescription','chart_notes','appeal_letter','eob','denial_letter',
        'prior_auth','eligibility_response','signed_swo','signed_cmn',
...
CREATE TABLE IF NOT EXISTS payer_auth_requirements (
    ...
    required_documents TEXT[] DEFAULT ARRAY['CMN','chart_notes'],
...
INSERT INTO payers (id, name, timely_filing_days, requires_cmn, requires_prior_auth, baseline_denial_rate, active) VALUES
  ('MEDICARE_DMERC', 'Medicare DMERC', 365, true, '["E0601","E1399","K0001","K0002","K0003","K0004","K0005"]', 0.9050, true),
  ('UHC', 'UnitedHealthcare', 180, false, '["E0601","K0001","K0004","K0005"]', 0.3200, true),
  ('AETNA', 'Aetna', 180, false, '["E0601","K0001"]', 0.2800, true),
  ('BCBS', 'Blue Cross Blue Shield', 365, false, '["E0601","K0001","K0004"]', 0.2500, true),
  ('CIGNA', 'Cigna', 180, false, '["E0601"]', 0.2700, true),
  ('HUMANA', 'Humana', 365, true, '["E0601","K0001","K0004","K0005"]', 0.3500, true),
