    ...
    <main className="public-page">
        ...
        <div className="subpage-hero-inner">
          <div className="sfm-reveal visible">
            ...
            <div className="cta-group">
              <a href="#intake" className="sfm-btn-primary">Start CarePath Intake <ChevronRight size={14} /></a>
              <a href="#pathways" className="sfm-btn-secondary">View Pathways</a>
            </div>
          </div>
          <div className="sfm-reveal sfm-reveal-delay-2 visible">
            <div className="opseq-card">
              <p className="opseq-title">Core Operating Sequence</p>
              <div className="opseq-steps">
                {operatingSequence.map((step, index) => {
                  const Icon = step.icon;
                  return (
                    <div className="opseq-step" key={step.label}>
      ...
      <section className="sub-section" id="pathways">
        ...
        <div className="pathway-grid">
          {pathways.map((pathway, index) => {
            ...
            return (
              <article className={`pathway-card sfm-reveal sfm-reveal-delay-${(index % 3) + 1}`} key={pathway.name}>
      ...
      <div className="sub-section-alt" id="intake">
        <div className="sub-section-inner">
          ...
          <div className="intake-form sfm-reveal sfm-reveal-delay-1">
            ...
            <button className="sfm-btn-primary intake-submit" disabled aria-label="Submit intake form (coming soon)">
